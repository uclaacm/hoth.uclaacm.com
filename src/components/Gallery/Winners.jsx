...
export default function Winners({ year }) {
    ...
    const hoth9 = [
        ...
        },
        {
            ...
            description: 'PlannedBruin is a class schedule optimizer for UCLA students. By inputting a major, the website will offer a potential 4-year degree map by quarter, helping to avoid stress regarding pre-requisites.',
        ...
        },
        {
            year: '9',
            appName: 'Green Ride',
            description: 'Google Maps, but with a CO2 emissions calculator that takes the route, car, and number of passengers to show how much CO2 each person is emitting to inspire more environmentally conscious traveling.',
        ...
        },
        {
            year: '9',
            appName: 'Habituate',
            description: 'Aristotle said: \'We are what we repeatedly do. Excellence, then, is not an act, but a habit.\' Habituate is a social app that allows you to track your habits and form the perfect morning routine.',
        ...
        },
        {
            ...
            description: 'A mobile application using React Native to raise equity by facilitating communication among deafblind communities.',
        ...
        },
        {
            year: '9',
            appName: 'Loom',
            description: 'Ever wanted a platform to write out your creative thoughts? Love collaborating with friends? Fret no more. With Loom, you spin your yarns a chapter at a time, liking them and inspiring others as well.',
    ...
    const hoth8 = [
        {
            year: '8',
            appName: 'Nudge',
            description: 'Nudge is the social self-care habit tracker you never knew you needed. Show friends you care by sending them personalized nudges to keep up with healthy habits. Grow nudges into deeper conversations.',
            category: 'Best Overall',
            image: 'nudge',
        ...
        },
        {
            ...
            description: 'Being alone and socially-deprived during quarantine makes each day quite monotonous. Dusk to Dawn aims to help by allowing users to wake up and fall asleep to voice messages sent by friends.',
        ...
        },
        {
            ...
            description: 'Our app provides the platform for a neighborhood clothes exchange program, enabling users to skip the hassle, financial obstacles, and environmental impact of buying new clothes.',
            category: 'Best Mobile',
        ...
        },
        {
            year: '8',
            appName: 'EyeMotion',
            description: 'EyeMotion is a meditation app that analyzes eye movement to provide personalized feedback about the quality of one\'s meditation, such as by detecting restlessness, anxiety, or negative emotion.',
            category: 'Best Web',
            image: 'eyemotion',
        ...
        },
        {
            year: '8',
            appName: 'EmoSign',
            description: 'To translate sign to language. To translate text to emotion. To connect us with people who need assistance in communication',
            category: 'Best Web',
            image: 'emosign',
        ...
        },
        {
            year: '8',
            appName: 'Reassure',
            description: 'Ever had a trouble and not been able to share it? Ever just needed to vent a bit? Then you just might love Reassure! With Reassure, you can anonymously disclose your troubles and receive support.',
            category: 'You Do You',
            image: 'reassure',
    ...
    const hoth7 = [
        {
            year: '7',
            appName: 'SYFGames',
            description: 'An multi-platform game that you can play with friends to compete and see who can recognize music the quickest and most accurate!',
            category: 'Best Hack',
            image: 'syfgames',
        ...
        },
        {
            year: '7',
            appName: 'Wave',
            description: 'Wave allows for people to use hand gestures to control their computers.',
        ...
        },
        {
            ...
            description: 'Asteroids - with rhythm. Combining the latest innovations in rhythm-based gaming with the classic asteroids arcade game.',
            category: 'Best Game',
        ...
        },
        {
            ...
            description: 'Navigating the dining hall menus on the UCLA Housing app is painstakingly slow. Delightful Diners provides a comprehensive nutritional overview of the menus with just a few voice commands.',
    ...
    const hoth6 = [
        {
            year: '6',
            appName: 'REACTions',
            description: 'Don\'t just press like or dislike buttons on videos. React to them.',
            category: 'Best Hack',
            image: 'anon',
        ...
        },
        {
            ...
            description: 'A mobile app that allows roommates in an apartment to handle expenses and chores',
        ...
        },
        {
            ...
            description: 'Machine Learning algorithm to determine the probability of getting into graduate school',
            category: 'Best Machine Learning Project',
        ...
        },
        {
            year: '6',
            appName: 'Phase Shift',
            description: '2D Platformer where two players control the same character and must cooperate to solve puzzles and fight enemies',
            category: 'Best Game',
            image: 'anon',
    ...
    const hoth5 = [
        ...
        },
        {
            ...
            description: 'A VR experience featuring bombs, balls, and exponentially increasing levels of stress.',
        ...
        },
        {
            ...
            description: 'Two players play with gravity and collaborate to deliver a key to a treasure chest.',
            category: 'Best Game',
            image: 'gravityfall',
    ...
    const hoth4 = [
        ...
        },
        {
            year: '4',
            appName: 'Gotta Go!',
            description: 'Step into the daily struggle of guys everywhere. Introducing the world\'s first Bathroom Simulator',
        ...
        },
        {
            year: '4',
            appName: 'Memo4Me',
            description: 'Memo 4 Me is a web-based communication application between attendees of various events',
    ...
    const hoth3 = [
        {
            ...
            description: 'A smart class selector for future class plan based on optimal professor and class ratings',
            category: '1st Place Overall',
            image: 'anon',
        ...
        },
        {
            year: '3',
            appName: 'ClassTime',
            description: 'A website designed to help you plan how long it takes to get between classes or places',
            category: '3rd Place Overall',
            image: 'anon',
        ...
        },
        {
            ...
            description: 'A Scientist gets caught trapped back in time and has to platform to get his papers back',
            category: 'Best Design',
            image: 'anon',
    ...
    const hoth2 = [
        {
            year: '2',
            appName: 'Eve',
            description: 'The only App you need for UCLA events, either posted on Facebook or from the web',
        ...
        },
        {
            ...
            description: 'Missed the latest basketball game? Forgot where Hack on the Hill is? What the Happening is here to help!',
        ...
        },
        {
            year: '2',
            appName: 'Delp',
            description: 'A Chrome Extension enabling people to rate each dish on the UCLA dining menu website',
        ...
        },
        {
            ...
            description: 'user sends mood/personalized note around the world; another user "grabs" note and sends back personalized song rec',
    ...
    return (
        <div className='outer-winners-container'>
            ...
            <button className='all-posts-button'>
                    <a href={allPosts} target='_blank' rel='noreferrer'>See All Projects</a>
            </button>
        </div>
